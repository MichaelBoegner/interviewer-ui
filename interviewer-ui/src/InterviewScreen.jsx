          ...
          <>
            ...
            <div className="border-b border-green-500 pb-2 mb-4 flex flex-col md:flex-row md:justify-between items-center">
              <div className="text-yellow-400 text-xs mb-2 md:mb-0">
                <span className="mr-2">[SYSTEM]:</span> Backend Interview
                Protocol Active
              </div>
            ...
            {/* ✅ Chat Window */}
            <div
              className="w-full h-80 overflow-y-auto p-4 bg-black border border-green-600 font-mono text-sm mb-4 retro-scrollbar"
                ...
                <>
                  ...
                  <div className="relative mt-4">
                    {isCodeMode ? (
                      ...
                      <div className="flex">
                        <div className="bg-gray-800 text-yellow-400 p-2"></div>
                        <textarea
                          value={input}
